        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <p className="text-gray-400 mt-6 text-lg max-w-xl">
              Explore the natural transformations achieved through our dental expertise.
            </p>
            ...
            <div className="mt-8">
              <a
                ...
                className="inline-flex items-center gap-2 btn-green px-8 py-4 rounded-full text-white font-semibold transform hover:scale-105 transition-transform"
              >
